...
import { LAUNCH_PAGE_CONTEXT_CORES, LAUNCH_PAGE_CONTEXT_ROCKET, LAUNCH_PAGE_CONTEXT_SHIPS, LAUNCH_PAGE_CONTEXT_PAYLOAD } from './LaunchConsts';
...
export const LaunchPage = () => {
    ...
    const [activeContext, setActiveContext] = useState(LAUNCH_PAGE_CONTEXT_CORES)
